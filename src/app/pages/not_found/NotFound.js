  ...
  return (
    <>
      <div className='container-fluid d-flex justify-content-center'>
        <div className='row error-contents'>

          <svg className='image-404' viewBox='0 0 429.4 301.63' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path className='cls-2' d='M28.3 188.16h138v2h-138z'/>
            <circle className='cls-2' cx='39.18' cy='179.11' r='2.52'/>
            <circle className='cls-2' cx='47' cy='179.11' r='2.52'/>
            <circle className='cls-2' cx='54.82' cy='179.11' r='2.52'/>
            ...
            <circle className='cls-2' cx='123.99' cy='217.4' r='4.68'/>
            <circle className='cls-1' cx='127.08' cy='215.92' r='1.48'/>
            <circle className='cls-2' cx='70.49' cy='217.4' r='4.68'/>
            <circle className='cls-1' cx='73.58' cy='215.92' r='1.48'/>
            <ellipse className='cls-1' cx='96.55' cy='297.08' rx='85.78' ry='4.55'/>
            <path className='cls-2'
            ...
            <text className='error-code' x='244' y='140'>
              404
            </text>
          </svg>
          ...
          <div className="d-flex justify-content-start flex-column">
            ...
            <h2 className='not-found ng-scope' translate='non_branded_page_not_found_title'>
              PÁGINA NÃO ENCONTRADA
            </h2>

            <LinkWrapper to='/institutes'
                         className='btn btn-lg btn-outline-not-found btn-block text-uppercase w-25 mt-3' >
              Voltar ao Início
            </LinkWrapper>
          </div>
